  ...
  <body>
    ...
    <script>
      ...
      function openModal() {
        ...
        $('.modal-title').text('Tambah Metode'); // Set Title to Bootstrap modal title
      }

      function closeModal(){
        $('#RegisterValidation')[0].reset();
        $('#modal').modal('hide');
        $('.modal-title').text('Tambah Metode');
      }
      ...
      function edit(id) {
        ...
        $.ajax({
            url : "<?php echo base_url(); ?>metode/metode_edit/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
              ...
              $('.modal-title').text('Edit Metode'); // Set title to Bootstrap modal title
      ...
      function openModalDelete(id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '<?php echo base_url(); ?>metode/metode_deleted/' + id,
              type: 'DELETE',
              error: function() {
      ...
      function save()
      {
        ...
        if(save_method == 'add') {
          url = "<?php echo base_url(); ?>metode/metode_add";
        } else {
          url = "<?php echo base_url(); ?>metode/metode_update";
        }
      ...
      $(document).ready(function() {
        table = $('#order-table').DataTable({ 
            ...
            "ajax": {
              "url": "<?php echo base_url(); ?>metode/metode_list",
              "type": "POST",
            },
