  ...
  <body>
    ...
    <script>
      ...
      function edit(id) {
        ...
        $.ajax({
            url : "<?php echo base_url(); ?>pelanggan/pelanggan_edit/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
              ...
              var imgs = '<?php echo base_url(); ?>upload/pelanggan_images/' + data.logo;
      ...
      function openModalDelete(id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: '<?php echo base_url(); ?>pelanggan/pelanggan_deleted/' + id,
              type: 'DELETE',
              error: function() {
      ...
      function save()
      {
        ...
        if(save_method == 'add') {
          url = "<?php echo base_url(); ?>pelanggan/pelanggan_add";
        } else {
          url = "<?php echo base_url(); ?>pelanggan/pelanggan_update";
        }
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable({ 
            ...
            "ajax": {
              "url": "<?php echo base_url(); ?>pelanggan/pelanggan_list",
              "type": "POST",
            },
