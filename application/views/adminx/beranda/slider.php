  ...
  <body>
          ...
          <div class="modal-body">
            <form id="RegisterValidation" enctype="multipart/form-data">
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="slider_name" name="slider_name" placeholder="Slider Name">
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="email" class="form-control" id="main_title" name="main_title" placeholder="Main Title">
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="form-group row mb-3">
              ...
              <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="url" class="form-control" id="button_link" name="button_link" placeholder="Button Link">
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="form-group row mb-3">
    ...
    <script>
      ...
      function edit(id) {
        ...
        $.ajax({
            url : "<?php echo base_url(); ?>slider/slider_edit/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
              ...
              $('[name="slider_name"]').val(data.slider_name);
              $('[name="main_title"]').val(data.main_title);
              $('[name="sub_title"]').val(data.sub_title);
              $('[name="button_text"]').val(data.button_text);
              $('[name="button_link"]').val(data.button_link);
              $('[name="aktivasi"]').val(data.aktivasi);

              var imgs = '<?php echo base_url(); ?>upload/slider_images/' + data.slider_image;
      ...
      function save()
      {
        ...
        if(save_method == 'add') {
          url = "<?php echo base_url(); ?>slider/slider_add";
        } else {
          url = "<?php echo base_url(); ?>slider/slider_update";
        }
      ...
      $(document).ready(function() {
        ...
        table = $('#order-table').DataTable({ 
            ...
            "ajax": {
              "url": "<?php echo base_url(); ?>slider/slider_list",
              "type": "POST",
            },
            ...
            "aoColumns": [
              ...
              { "Slider Name": "Slider Name" , "sClass": "text-left" },
              { "Slider Image": "Slider Image" , "sClass": "text-left" },
              { "Main Title": "Main Title" , "sClass": "text-left" },
              { "Sub Title": "Sub Title" , "sClass": "text-left"},
              { "Button Text": "Button Text" , "sClass": "text-left"},
              { "Button Link": "Button Link" , "sClass": "text-left"}
            ],
