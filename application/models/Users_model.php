...
class Users_model extends CI_Model {
  ...
  var $column_order   = array('nip', 'email_pegawai', 'username', 
                              'level', 'aktivasi', 'last_login', null);
  var $column_search  = array('nip', 'email_pegawai', 'username', 
                              'level', 'aktivasi', 'last_login');
